...
# Delete all posts created by a sublessor
...
# Create sublessor profile and add in details
...
# Get information about reviews on a specific sublessor
@sublessors.route('/reviews/review_content/<sbless_user>', methods=['GET'])
...
# Create and add lease details about the sublet property
